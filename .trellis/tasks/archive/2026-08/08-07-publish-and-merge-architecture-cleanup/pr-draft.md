...
- Enforce a client-safe dashboard contract boundary and keep helpers out of App Router route-module exports.

## Verification

- `npm test -- --runInBand` — 82 suites passed; 760 tests passed, 1 skipped.
- Production Next build, strict TypeScript, changed-source ESLint, public-DB invariant, card-template validation, AMEX userscript artifact checks, package-context discovery, lockfile graph, Markdown-link review, and `git diff --check` passed.
